...
class Bottleneck_RFCA(nn.Module):
    """Standard bottleneck."""
...
class C2fRFCA(C2f):
    ...
    def __init__(self, c1: int, c2: int, n: int = 1,
        ...
        self.m = nn.Sequential(*(Bottleneck_RFCA(c_, c_, shortcut, g, e=1.0)for _ in range(n)))


if __name__ == "__main__":
    x = torch.randn(1, 256, 40, 40)

    model = C2fRFCA(c1=256, c2=256, n=2, shortcut=True, g=1, e=0.5)
    y = model(x)
